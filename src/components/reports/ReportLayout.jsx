...
export default function ReportLayout({
    ...
    return (
        <div className="space-y-6 animate-fade-in">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <Button
                            ...
                            onClick={onPrint}
                            disabled={loading}
                            className="rounded-lg border-gray-300 dark:border-slate-600 flex items-center gap-2"
                        >
                        ...
                        <Button
                            ...
                            onClick={onExportPDF}
                            disabled={loading}
                            className="rounded-lg bg-slate-900 hover:bg-slate-800 dark:bg-blue-600 dark:hover:bg-blue-700 flex items-center gap-2"
                        >
            ...
            <div
                id="report-content"
                className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 p-8 shadow-md rounded-lg font-sans"
            >
                {/* Document Header */}
                <div className="flex justify-between items-start border-b-2 border-slate-900 dark:border-slate-700 pb-6 mb-8">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-slate-900 dark:text-white font-bold text-2xl uppercase tracking-tighter">
                    ...
                    <div className="text-right space-y-1">
                        <h1 className="text-xl font-black text-slate-900 dark:text-white uppercase leading-none">{title}</h1>
                ...
                {/* Document Footer */}
                <div className="mt-12 pt-4 border-t border-gray-100 dark:border-slate-800 flex justify-between items-center text-[10px] text-slate-400 uppercase font-medium">
